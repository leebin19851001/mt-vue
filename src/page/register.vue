...
export default {
  ...
  methods: {
    ...
    input() {
        var regStr = /(\w)+/g;
        var regNum = /(\d)+/g;
        var reg_underline = /_/g;
        var strongth = this.registerForm.password.match(regStr) && this.registerForm.password.match(regNum) && this.registerForm.password.match(strongth);
